          ...
          child: Center(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Image.asset('images/forgot.PNG',height: 200, width: 200,),
                  RichText(text: TextSpan(
                    text: '',
                    children: [
                      TextSpan(text: 'Forgot Password? ',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.red)),
                      TextSpan(text: "Don\'t worry! Provide us your registered email, we will send you a link to reset your password.",style: TextStyle(color: Colors.red,fontSize: 13)),
                    ]
                  ),),
                  SizedBox(height: 20,),
                  TextFormField(
                        ...
                        onPressed: (){
                            if(_formkey.currentState.validate()){
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Check your Email ${_emailTextController.text} for reset password link')));
                            }
